...
export default function Index() {
  return (
    <div className="overflow-hidden">
      ...
      <section
        className="relative min-h-screen md:min-h-[85vh] flex items-start md:items-center bg-cover bg-center bg-no-repeat pt-20 md:pt-0"
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl animate-fade-in-up py-4 md:py-0">
            {/* Badge */}
            ...
            {/* Stats Row */}
            <div className="grid grid-cols-2 gap-4 md:flex md:flex-wrap md:gap-8 pt-6 md:pt-8 border-t border-white/20">
              {stats.map((stat) => (
                <div key={stat.label} className="flex items-center gap-2 md:gap-3">
                  ...
                  <div>
                    <div className="font-bold text-white text-sm md:text-base">{stat.value}</div>
